...
- (NSString *)jsonString:(NSString *)oriString{
    NSString *tmpStr = [oriString stringByReplacingOccurrencesOfString:@"\"" withString:@"\\\""];
    NSString *tmpStr1 = [tmpStr stringByReplacingOccurrencesOfString:@"=" withString:@"\":\""];
    NSString *tmpStr2 = [tmpStr1 stringByReplacingOccurrencesOfString:@"&" withString:@"\",\""];
    NSString *tmpStr3 = [tmpStr2 stringByAppendingString:@"\"}"];
    NSString *add = @"{\"";
    NSString *jsonStr = [add stringByAppendingString:tmpStr3];
    return jsonStr;
}
